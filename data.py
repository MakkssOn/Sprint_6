class TestData:
    test_data_user1 = ['Артём', 'Артопон', 'Новиградский проспект, 16', 'Университет', '+78995755685', '10.09.2024',
                 'Хм, распогодилось :)']

    test_data_user2 = ['Саша', 'Барбьос', 'Фундук и Артемон', 'Ваня', '+776512294433', '10.09.2024',
                 'Очень хочется кататься!']
